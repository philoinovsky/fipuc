// b. compare efficiency of Taximan2D and Taximan2D_2:
//      Taximan2D_2 is more efficient and straitforward, less function pointer
//      jump will be used at the scene.
#include <math.h>
#include <iostream>
#include <functional>
...
Taximan2D =
    std::bind(Taximan3D, std::placeholders::_1, std::placeholders::_2,0.0,
    std::placeholders::_3, std::placeholders::_4, 0.0);

// Q2. 2nd version of Taximan2D
double Taximan2D_2(double x1, double y1, double x2, double y2)
{
